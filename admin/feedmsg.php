                                            ...
                                            <table class="table " id="table_id">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th scope="col" class="sorting" tabindex="0" aria-controls="user_table" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending" style="width: 155.406px;">Feedback</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">              
                                                            ...
                                                            <td><?= $value['email'] ?></td>
                                                            <td><?= $value['number'] ?></td>
                                                            <td><p style="white-space: nowrap;width:300px !important;text-overflow: ellipsis;overflow: hidden;"><?= $value['feedback'] ?></p></td>
                                                            <td><span class="badge <?= $value['status'] == 1 ? "badge-success" : "badge-warning" ?>"><?= $value['status'] == 1 ? "Read" : "Not Read" ?></span></td>
                                                            <td><a class="text-success mr-2" href="updatecontact.php?id=<?= $value['id'] ?>&page=2"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a><a class="text-danger mr-2" onclick="deleteuser(<?= $value['id'] ?>)"><i class="nav-icon i-Close-Window font-weight-bold"></i></a></td>
                                                        </tr>
                                                    <?php
                                                    }
                                                    ?>
