        ...
        ?>
                    <div class="minicart__product--items d-flex">
                        ...
                        <div class="minicart__text">
                            ...
                            <span class="color__variant"><b>
                                    <p style="white-space: nowrap;width:150px !important;text-overflow: ellipsis;overflow: hidden;"><?= $finalresult['desc'] ?></p>
                                </b></span>
                            ...
                            <div class="minicart__text--footer d-flex align-items-center">
                                ...
                                <a onclick="deletecard(<?= $resu['id'] ?>)"><button class="minicart__product--remove">Remove</button></a>
                            </div>
                        </div>
                    </div>
