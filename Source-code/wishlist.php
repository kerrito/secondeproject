                        ...
                        <div class="cart__table">
                            <table class="cart__table--inner">
                                ...
                                <tbody class="cart__table--body">
                                    ...
                                    $sql = "SELECT * FROM `wishlist` WHERE `user_email`='$email'";
                                    ...
                                    ?>
                                                <tr class="cart__table--body__items">
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <span class="cart__price"><?= $finalresult['price'] ?> Rs</span>
                                                    </td>
                                                    <td class="cart__table--body__list text-center">
                                                        <span class="in__stock text__secondary"><?= $finalresult['stock'] > 0 ? "In Stock" : "Out Of Stock"; ?></span>
                                                    </td>
                                                    <td class="cart__table--body__list text-right">
                                                        <a class="wishlist__cart--btn primary__btn" onclick="addtocard(<?= $finalresult['id'] ?>)">Add To Cart</a>
                                                    </td>
                                                </tr>
