...
<body>
    ...
    <main class="main__content_wrapper">
        ...
        <!-- Starting feedback Form -->

        <section class="contact__section align-items-center section--padding">
            <div class="container ">
                <div class="section__heading text-center mb-40">
                    <h2 class="section__heading--maintitle style2">Feedback</h2>
                </div>
                <div class=" position__relative align-items-center d-flex justify-content-center">

                    <div class="">
                        <h3 class="contact__form--title mb-40">Feedback Us</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="firstname" id="input1" pattern="[A-za-z ]{4,16}" title="" placeholder="Your First Name" type="text" required>
                                        <p class="text-danger d-none" id="input1p">Name must contain 3 to 8 character no special character allowed</p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <p class="text-danger d-none" id="input2p">Last Name must contain 3 to 8 character no special character allowed</p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input3">Phone Number <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="number" id="input3" placeholder="Phone number" pattern="[0-9]{11}" title="" type="tel" required>
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-15">
                                        <label class="contact__form--label" for="input5">Feedback<span class="contact__form--label__star">*</span></label>
                                        <textarea class="contact__form--textarea" name="message" id="input5" placeholder="Write Your Feedback here" required></textarea>
                                        <p class="text-danger d-none" id="input5p">Feedback must contain least 15 to 200 Character no special character allowed</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- <div class="contact__info border-radius-5">
                        <div class="contact__info--items">
                            <h3 class="contact__info--content__title text-white mb-15">Feedback Us</h3>
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Feedback us on call <br> <a href="tel:+01234-567890">+01234-567890</a> <a href="tel:++01234-5688765">+01234-5688765</a> </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content d-flex align-items-center">
                                    <p class="contact__info--content__desc text-white"> <a href="mailto:Admin@gmail.com">Admin@gmail.com</a> </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> Metro star gate Karachi,
                                        Pakistan
                                        NY 750065.</p>
                                </div>
                            </div>
